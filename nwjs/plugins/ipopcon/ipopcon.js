...
//console.log("ajhksldhjkladjhkladljhasjlhasdjhkasdjhkasdjhkasdjhkkjh");
//console.log(SensorTag);

//SensorTag.discover(null);
...
/*
 'ipopcon_discover_device':{
            ...
            init: function() {
                this.jsonInit({
                    "id": "ipopcon_discover_device",
                    "message0": "discover the ipopcon device",
                    "args0": [
                    ],
                    "inputsInline": true,
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readIrTemperature(function(error, objectTemperature, ambientTemperature) {
			alert('\tobject temperature = ' + objectTemperature.toFixed(1) );
